...
public class Posts extends TableImpl<PostsRecord> {
    ...
    private static final long serialVersionUID = -1034803845;
     ...
     */
    public final TableField<PostsRecord, Timestamp> CREATED_ON = createField("CREATED_ON", org.jooq.impl.SQLDataType.TIMESTAMP.precision(6).defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
